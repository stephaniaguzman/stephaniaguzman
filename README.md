...
- **BSc in Sciences, major in Telecommunications Engineering** — Pontificia Universidad Católica del Perú. A mathematics- and physics-heavy engineering science degree, specialised in networks, protocols and distributed systems.
...
- **ML systems and performance** — the infrastructure that trains and serves models: throughput, memory, cost, and where the bottlenecks actually are
